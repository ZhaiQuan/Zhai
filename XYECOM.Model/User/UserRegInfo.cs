...
namespace XYECOM.Model
{
    ...
    public class UserRegInfo
    {
        ...
        private Model.UserGradeInfo userGrade = null;

        /// <summary>
        /// 用户等级信息
        /// </summary>
        public Model.UserGradeInfo GradeInfo
        {
            get { return userGrade; }
            set { userGrade = value; }
        }


        private Model.UserGradePopedomInfo _GradePopedomInfo = new UserGradePopedomInfo();
        /// <summary>
        /// 用户等级权限信息
        /// </summary>
        public Model.UserGradePopedomInfo GradePopedomInfo
        {
            get { return _GradePopedomInfo; }
            set { _GradePopedomInfo = value; }
        }
