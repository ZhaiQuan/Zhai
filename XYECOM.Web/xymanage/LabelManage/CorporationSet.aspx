<%@ Page Language="C#" AutoEventWireup="true" Inherits="xymanage_LabelManage_CorporationSet"
    CodeBehind="CorporationSet.aspx.cs" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>企业信息标签设置</title>
                    ...
                    <table width="100%" class="xy_tb xy_tb2 setLabelData" id="base">
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="hidptid" runat="server" type="hidden" value="" /><input id="hidweburl"
                                    runat="server" type="hidden" /><input id="hidsuffix" runat="server" type="hidden" />
                            </td>
                        </tr>
                        <tr>
                            <th>
...
var cla = new ClassType("cla",'company','classType','hidptid');
cla.Mode = "select";
cla.Init();
</script>
