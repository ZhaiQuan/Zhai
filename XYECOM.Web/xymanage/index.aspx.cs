...
public partial class xymanage_index : XYECOM.Web.BasePage.ManagePage
{
    ...
    private void getgradelist()
    {
        ...
        this.ddlgrade.DataSource = this.ddlgrade.DataSource = ug.GetDataTable();
        this.ddlgrade.DataTextField = "UG_Name";
        this.ddlgrade.DataValueField = "UG_ID";
    ...
    {
        Response.Redirect("/xymanage/UserManage/UserGradePopedom.aspx?UG_ID=" + this.ddlgrade.SelectedValue);
    }
