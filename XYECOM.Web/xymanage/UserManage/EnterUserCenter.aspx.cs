    ...
    public partial class EnterUserCenter : XYECOM.Web.BasePage.ManagePage
    {
        ...
        private void Enter(long userId)
        {
            ...
            if (userInfo.Type)
            {
                ...
                {
                    XYECOM.Core.Utils.WriteCookie("UserLevel", userGreadInfo.GradeName.ToString(), webInfo.CookieDomain);
                    XYECOM.Core.Utils.WriteCookie("UserLevelImg", userGreadInfo.SmallIconName, webInfo.CookieDomain);
                }
            }
