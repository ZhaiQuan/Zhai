...
public partial class xymanage_basic_UserInfoSet : XYECOM.Web.BasePage.ManagePage
{
    ...
    private void ddlDataBind()
    {
        ...
        this.ddlusertype.DataTextField = "UG_Name";
        this.ddlusertype.DataValueField = "UG_ID";
    ...
    private void GetWebInfo()
    {
        ...
        if (webInfo.UserDefaultLevel > 0)
            this.ddlusertype.SelectedValue = webInfo.UserDefaultLevel.ToString();
    ...
    protected void btok_Click(object sender, EventArgs e)
    {
        ...
        if (this.ddlusertype.SelectedValue != "")
            webInfo.UserDefaultLevel = XYECOM.Core.MyConvert.GetInt32(this.ddlusertype.SelectedValue);
