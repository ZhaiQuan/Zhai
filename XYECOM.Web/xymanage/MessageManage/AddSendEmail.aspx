    ...
    <td valign="top">
        ...
        <td align="left" class="select_user">
         <div id="a2">
	        ...
	        <div id="b22">
	            <input type="radio" name="rbt" id="rbtugp" onclick="rbtchanage(0)" />按用户组进行发送
                <br />
                <input type="radio" name="rbt" id="rbtsearch" onclick="rbtchanage(1)" checked="checked"/>搜索相关用户进行发送
                <hr/>
                <div id="panugp" style="display:none">
                    <asp:CheckBoxList id="CBL" runat="server" DataTextField ="UG_Name" DataValueField ="UG_ID" RepeatDirection="Vertical">
                    </asp:CheckBoxList>
                    <hr />
                    <input id="chkAll2" onclick="chkAll22();" type="checkbox" name="chkAll1" runat="server" />全选
                </div>
